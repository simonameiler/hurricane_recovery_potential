...
housing damage, as in table~\ref{tab:damage_distribution}. Right: the
same correlation after dividing both quantities by residential exposure
units, so that damage intensities rather than totals are compared.
Counties without exposure-unit data are dropped from the normalized
comparison.}
