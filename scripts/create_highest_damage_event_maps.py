#!/usr/bin/env python3
"""
Create 3-panel maps for the 5 highest total damage events.
Shows contrast with critical vulnerability events.
"""
...
def create_event_map(event_id, gdf_all, event_data, output_dir='/Users/simonameiler/Documents/work/03_code/repos/hurricane_recovery_potential/analysis_output'):
    ...
    # Save figure
    output_file = f'{output_dir}/highest_damage_event_{event_id}_3panel.png'
...
def main():
    print("=" * 80)
    print("CREATING 3-PANEL MAPS FOR HIGHEST DAMAGE EVENTS")
    print("=" * 80)
    ...
    coastal_states = ['01', '09', '10', '12', '13', '22', '23', '24', '25', '28', 
                     '33', '34', '36', '37', '44', '45', '48', '51', '42']  # 19 coastal states
    ...
    df = pd.read_csv('/Users/simonameiler/Documents/work/03_code/repos/hurricane_recovery_potential/analysis_output/event_county_quadrants.csv')
    df['fips'] = df['fips'].astype(str).str.zfill(5)
    
    # Top 5 highest damage events
    highest_damage_events = [765, 800, 4347, 3907, 1360]
    
    for event_id in highest_damage_events:
        print("\n" + "=" * 80)
    ...
    print("\nFiles created:")
    for event_id in highest_damage_events:
        print(f"  - highest_damage_event_{event_id}_3panel.png")
