#!/usr/bin/env python3
"""
Create 3-panel maps for the 5 highest repair cost events.
"""
...
def create_event_map(event_id, gdf_all, event_data, output_dir='/Users/simonameiler/Documents/work/03_code/repos/hurricane_recovery_potential/analysis_output'):
    ...
    # Save figure
    output_file = f'{output_dir}/highest_repaircost_event_{event_id}_3panel.png'
...
def main():
    print("=" * 80)
    print("CREATING 3-PANEL MAPS FOR HIGHEST REPAIR COST EVENTS")
    print("=" * 80)
    ...
    # Top 5 highest repair cost events
    highest_cost_events = [765, 3907, 4347, 3577, 2353]
    
    for event_id in highest_cost_events:
        print("\n" + "=" * 80)
        ...
        output_file = create_event_map(event_id, gdf_counties, df)
    ...
    print("\nFiles created:")
    for event_id in highest_cost_events:
        print(f"  - highest_repaircost_event_{event_id}_3panel.png")
